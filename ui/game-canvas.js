  ...
  keyDownHandler(e) {
    ...
    switch (e.key) {
      ...
      case 'd':
        ...
        break;
      case ' ':
        let existBoxInHoleDirection = this.#map.checkBoxInHoleAround(
          this.#player
        );
        let existObstacleDirection = this.#map.checkObstaclesAround(
          this.#player
        );
        ...
        let y = this.#player.y;
        if (
          existBoxInHoleDirection.upperSide &&
